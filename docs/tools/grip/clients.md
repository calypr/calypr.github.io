...
GRIP has an API for making graph queries using structured data. Queries are defined using a series of step [operations](/queries/).
...
View a list of all available query operations [here](/queries/).
