...
When you create and upload files, you can tag them with identifiers to establish an initial skeleton graph. You can then retrieve that data using the [git-drs](/tools/git-drs/) command line tool and enhance the metadata using [forge](/tools/forge/docs/) to create a more complete graph representing your study.
