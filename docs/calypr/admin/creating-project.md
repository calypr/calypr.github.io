...
Options:
  --debug        Enable debug mode. GIT_DRS_DEBUG environment variable can also be used.
...
* `.drs/`: a hidden directory within your project that houses the internal data structure required for version control.
