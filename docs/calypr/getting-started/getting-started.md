...
For the following examples, we will use the `calypr` program with a project called `myproject`. Please use the `git drs remote list` command to verify what programs and projects you have access to.
