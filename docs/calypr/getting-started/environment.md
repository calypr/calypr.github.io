...
## 3.1 Install Git & Git‑LFS & Git-DRS
...
### 3.2.1 Formatting a new project
...
## 3.3 Verify configuration {#3.3-verify-configuration}
...
📖 More details: [File Tracking Guide](https://github.com/copilot/tools/git-drs/file-registration.md)

---

## 3.4 Add Your Files {#3.4-add-your-files}
...
\- data/sample1.bam  
\- data/sample2.bam  
\- results/[analysis.vcf.gz](http://analysis.vcf.gz)

### 3.4.2 Register S3 Files 
