...
<section class="business-hero">
  <div class="business-hero__copy">
    ...
    <div class="business-actions">
      <a href="products/" class="md-button md-button--primary">See products</a>
      <a href="solutions/" class="md-button">See solutions</a>
    </div>
  </div>
  <div class="business-hero__panel" aria-label="CALYPR platform capabilities">
    <img src="assets/solutions/manage-data.svg" alt="Manage governed biomedical data" />
  </div>
</section>
...
<section class="product-banners" aria-label="CALYPR product areas">
  <article class="product-banner product-banner--data">
    <div class="product-banner__copy">
      ...
      <div class="product-banner__links">
        <a href="products/manage-data/">Product overview</a>
        <a href="solutions/">Business use cases</a>
      </div>
    </div>
    <img src="assets/solutions/manage-data.svg" alt="" />
  </article>
  ...
  <article class="product-banner product-banner--compute">
    <div class="product-banner__copy">
      ...
      <div class="product-banner__links">
        <a href="products/manage-compute/">Product overview</a>
        <a href="solutions/">Business use cases</a>
      </div>
    </div>
    <img src="assets/solutions/manage-compute.svg" alt="" />
  </article>
  ...
  <article class="product-banner product-banner--integrate">
    <div class="product-banner__copy">
      ...
      <div class="product-banner__links">
        <a href="products/integrate-data/">Product overview</a>
        <a href="solutions/">Business use cases</a>
      </div>
    </div>
    <img src="assets/solutions/integrate-data.svg" alt="" />
  </article>
  ...
  <article class="product-banner product-banner--models">
    <div class="product-banner__copy">
      ...
      <div class="product-banner__links">
        <a href="products/manage-models/">Product overview</a>
        <a href="solutions/">Business use cases</a>
      </div>
    </div>
    <img src="assets/solutions/manage-models.svg" alt="" />
  </article>
</section>
...
<section class="business-section business-section--muted">
  ...
  <div class="business-actions business-actions--center">
    <a href="products/" class="md-button md-button--primary">Browse products</a>
    <a href="solutions/" class="md-button">Browse solutions</a>
  </div>
</section>
